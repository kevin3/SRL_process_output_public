...
class ParseSampleSheetRequest(object):
    ...
    def __init__(self, include=None, sample_sheet_content=None, resolve_prep_kits=None, resolve_prep_kits_by_name=None, resolve_index_sequence_info=None, enable_warnings_for_missing_cloud_sections=None, default_kits=None, local_vars_configuration=None):  # noqa: E501
        """ParseSampleSheetRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def include(self):
        """Gets the include of this ParseSampleSheetRequest.  # noqa: E501

        Include flags to specify what is included in the response  # noqa: E501

        :return: The include of this ParseSampleSheetRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def include(self, include):
        """Sets the include of this ParseSampleSheetRequest.

        Include flags to specify what is included in the response  # noqa: E501

        :param include: The include of this ParseSampleSheetRequest.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["PrepKitInfo"]  # noqa: E501
    ...
    def sample_sheet_content(self):
        """Gets the sample_sheet_content of this ParseSampleSheetRequest.  # noqa: E501

        The csv string of the sample sheet  # noqa: E501

        :return: The sample_sheet_content of this ParseSampleSheetRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def sample_sheet_content(self, sample_sheet_content):
        """Sets the sample_sheet_content of this ParseSampleSheetRequest.

        The csv string of the sample sheet  # noqa: E501

        :param sample_sheet_content: The sample_sheet_content of this ParseSampleSheetRequest.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def resolve_prep_kits(self):
        """Gets the resolve_prep_kits of this ParseSampleSheetRequest.  # noqa: E501

        If true, resolve prep kit information from sample sheet if possible  # noqa: E501

        :return: The resolve_prep_kits of this ParseSampleSheetRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def resolve_prep_kits(self, resolve_prep_kits):
        """Sets the resolve_prep_kits of this ParseSampleSheetRequest.

        If true, resolve prep kit information from sample sheet if possible  # noqa: E501

        :param resolve_prep_kits: The resolve_prep_kits of this ParseSampleSheetRequest.  # noqa: E501
        :type: bool
        """
    ...
    def resolve_prep_kits_by_name(self):
        """Gets the resolve_prep_kits_by_name of this ParseSampleSheetRequest.  # noqa: E501

        If true, attempt to resolve prep kits by name if they cannot be resolved using URN column  # noqa: E501

        :return: The resolve_prep_kits_by_name of this ParseSampleSheetRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def resolve_prep_kits_by_name(self, resolve_prep_kits_by_name):
        """Sets the resolve_prep_kits_by_name of this ParseSampleSheetRequest.

        If true, attempt to resolve prep kits by name if they cannot be resolved using URN column  # noqa: E501

        :param resolve_prep_kits_by_name: The resolve_prep_kits_by_name of this ParseSampleSheetRequest.  # noqa: E501
        :type: bool
        """
    ...
    def resolve_index_sequence_info(self):
        """Gets the resolve_index_sequence_info of this ParseSampleSheetRequest.  # noqa: E501

        If true, attempt to resolve index sequence info like Index Name and Position based on the index sequences  # noqa: E501

        :return: The resolve_index_sequence_info of this ParseSampleSheetRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def resolve_index_sequence_info(self, resolve_index_sequence_info):
        """Sets the resolve_index_sequence_info of this ParseSampleSheetRequest.

        If true, attempt to resolve index sequence info like Index Name and Position based on the index sequences  # noqa: E501

        :param resolve_index_sequence_info: The resolve_index_sequence_info of this ParseSampleSheetRequest.  # noqa: E501
        :type: bool
        """
    ...
    def enable_warnings_for_missing_cloud_sections(self):
        """Gets the enable_warnings_for_missing_cloud_sections of this ParseSampleSheetRequest.  # noqa: E501

        Enable warnings if cloud sections are not provided  # noqa: E501

        :return: The enable_warnings_for_missing_cloud_sections of this ParseSampleSheetRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def enable_warnings_for_missing_cloud_sections(self, enable_warnings_for_missing_cloud_sections):
        """Sets the enable_warnings_for_missing_cloud_sections of this ParseSampleSheetRequest.

        Enable warnings if cloud sections are not provided  # noqa: E501

        :param enable_warnings_for_missing_cloud_sections: The enable_warnings_for_missing_cloud_sections of this ParseSampleSheetRequest.  # noqa: E501
        :type: bool
        """
    ...
    def default_kits(self):
        """Gets the default_kits of this ParseSampleSheetRequest.  # noqa: E501

        Default kits to be used during sample sheet parsing  # noqa: E501

        :return: The default_kits of this ParseSampleSheetRequest.  # noqa: E501
    ...
    def default_kits(self, default_kits):
        """Sets the default_kits of this ParseSampleSheetRequest.

        Default kits to be used during sample sheet parsing  # noqa: E501

        :param default_kits: The default_kits of this ParseSampleSheetRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ParseSampleSheetRequest):
            return False
