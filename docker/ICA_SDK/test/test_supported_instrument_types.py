...
import ICA_SDK
from ICA_SDK.models.supported_instrument_types import SupportedInstrumentTypes  # noqa: E501
...
class TestSupportedInstrumentTypes(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ICA_SDK.models.supported_instrument_types.SupportedInstrumentTypes()  # noqa: E501
        if include_optional :
            return SupportedInstrumentTypes(
                instrument_types = [
                    ICA_SDK.models.instrument_type_info.InstrumentTypeInfo(
                        instrument_type = '0', 
                ...
                instrument_platforms = [
                    ICA_SDK.models.instrument_platform_info.InstrumentPlatformInfo(
                        instrument_platform = '0', 
                        display_name = '0', 
                        run_planning_supported = True, 
                        cloud_orchestration_supported = True, 
