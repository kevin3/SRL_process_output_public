...
import ICA_SDK
from ICA_SDK.models.parse_sample_sheet_response import ParseSampleSheetResponse  # noqa: E501
...
class TestParseSampleSheetResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ICA_SDK.models.parse_sample_sheet_response.ParseSampleSheetResponse()  # noqa: E501
        if include_optional :
            return ParseSampleSheetResponse(
                sequencing_run = ICA_SDK.models.parsed_sequencing_run.ParsedSequencingRun(
                    input_container_identifier = '0', 
                    run_configuration = ICA_SDK.models.update_sequencing_run_configuration_request.UpdateSequencingRunConfigurationRequest(
                        run_name = '0', 
                        description = '0', 
                        regulatory_mode = 'RUO', 
                        instrument_type = '0', 
                    ...
                    run_prep_kit_info = ICA_SDK.models.sequencing_run_prep_kit_info.SequencingRunPrepKitInfo(
                ...
                warnings = [
                    ICA_SDK.models.sample_sheet_parsing_warning.SampleSheetParsingWarning(
                        section = '0', 
                        field = '0', 
                        message = '0', 
                        severity = '0', )
