...
import ICA_SDK
from ICA_SDK.models.bulk_file_update_request import BulkFileUpdateRequest  # noqa: E501
...
class TestBulkFileUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = ICA_SDK.models.bulk_file_update_request.BulkFileUpdateRequest()  # noqa: E501
        if include_optional :
            return BulkFileUpdateRequest(
                items = [
                    ICA_SDK.models.bulk_file_update_item.BulkFileUpdateItem(
                        id = '0', 
